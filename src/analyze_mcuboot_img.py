...
# Found here: https://lists.zephyrproject.org/g/users/topic/mcumgr_how_to_calculate_hash/30139932
# This is a modified version of the script provided by Marti Bolivar. 
# The original script can be found here: https://gist.github.com/mbolivar/285309cca792f746d6c698f56941041a
# For more information about mcuboot image format read: https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/mcuboot/design.html#image-format
...
def get_image_hash(image_path):
    """Return hexstring of image hash"""
    ...
    while tlv_off < tlv_end:
        ...
        if tlv_hdr.len <= 32:
            ...
            value = ''.join('{:02x}'.format(b) for b in contents[start:end])  # we need a string representation of value

            if tlv_hdr.type == 0x10:  # SHA256
                return value
            # print(value)
...
# sha256 = get_image_hash("../smartparks_app_files/app_update_v1.bin")
# print(f"Gotten image hash: {sha256}")